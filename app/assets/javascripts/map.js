$(window).load(function() {
    ...
    $(document).ajaxSuccess(function(event, data, settings) {
        ...
        let venues = data.responseJSON.venues
        let venueResultsHtml = ""
        let data = data.responseJSON
        setResultsGeolocation(data)
...
function setResultsGeolocation(data) {
    debugger;
...
//             createPin(myResult, index, address); // call the function that adds the marker
